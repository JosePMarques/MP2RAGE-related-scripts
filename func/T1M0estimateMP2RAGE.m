...
% MP2RAGEINV2nii is the nii structure resulting from loading the MP2RAGE
% INV2 image with or without Bias Correction
% with load_nii or load_untouch_nii
...
IntensityUncomb2=interp1(T1vector,IntensityUncomb(:,2),T1map.img(:));
M0map.img=reshape(double(MP2RAGEINV2nii.img(:))./IntensityUncomb2,size(MP2RAGEINV2nii.img));
